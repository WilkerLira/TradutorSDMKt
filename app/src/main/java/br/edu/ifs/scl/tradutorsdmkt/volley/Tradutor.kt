package br.edu.ifs.scl.tradutorsdmkt.volley
...
import br.edu.ifs.scl.tradutorsdmkt.Constantes.END_POINT
    ...
    inner class RespostaListener : Response.Listener<JSONObject> {
        override fun onResponse(response: JSONObject?) {
            try {
                                ...
                                it?.translations?.forEach {
                                   ...
                                   /* val clTransJ: Class<Translation> = Translation::class.java
                                    ...
                                    Log.v(
                                        ...
                                        "Nome da Classe Java: ${clTransJ.name}"
                                    )
                                    Log.v(
                                        mainActivity.getString(R.string.app_name),
                                        "Nome da Classe Kotlin: ${clTransK.qualifiedName}"
                                    )
                                    ...
                                    val getTextK: KProperty1.Getter<Translation, Any?> =
                                        clTransK.declaredMemberProperties.single { it.name == "text" }.getter*/
                ...
                mainActivity.tradutorHandler.obtainMessage(
                    RESPOSTA_TRADUCAO,
